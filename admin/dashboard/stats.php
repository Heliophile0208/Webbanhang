...
.dashboard-container {
    display: grid;
    grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); /* Linh hoạt chia cột */
...
.dashboard-box {
    ...
    color: white; /* Màu chữ trắng mặc định */
    font-weight: bold;
...
/* Hiệu ứng hover */
.dashboard-box:hover {
    transform: translateY(-5px); /* Nâng nhẹ ô khi hover */
...
.dashboard-box.low-stock {
    background-color: #fff4e5; /* Màu nền cam nhạt */
    color: #555; /* Màu chữ tối hơn */
    border-left: 5px solid #ffa502; /* Dải màu cảnh báo */
    text-align: left; /* Canh trái danh sách */
}

.low-stock h3 {
    font-size: 18px;
    color: #ff6f00; /* Màu cam đậm */
    margin-bottom: 10px;
}
...
@media (max-width: 768px) {
    .dashboard-container {
        grid-template-columns: 1fr; /* Các ô xếp chồng trên màn hình nhỏ */
        padding: 10px;
    }
}
</style>
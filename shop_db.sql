...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th10 21, 2024 lúc 12:43 PM
...
CREATE TABLE `categories` (
  ...
  `group` enum('Mùa','Thường Ngày','Bán Chạy','Ngày Lễ') COLLATE utf8_unicode_ci NOT NULL
...
(1, 'Đầm', 'Các loại đầm thời trang cho nữ, từ đầm dạ hội đến đầm công sở.', 'Ngày Lễ'),
...
(1, 2, 'Administrator', 'lethikimngan20803@gmail.com', '0928338155', 'TP HCM', NULL, 'TPHCM', 'TPHCM', '700000', 'Việt Nam', '2024-11-21 02:07:37', '2024-11-21 02:14:45'),
(2, 6, 'Lê Thị Kim Ngân', 'lethikimngan20803@gmail.com', '0928338155', '227 đường Phạm Văn Diêu, khu phố 3, phường Tân Hạnh, Thành phố Biên Hoà, tỉnh Đồng Nai', '0928338155', 'Biên Hoà', 'Đồng Nai', '810900', 'Việt Nam', '2024-11-21 09:57:41', '2024-11-21 09:57:41');
...
(38, 6, 1350000.00, 'pending', '2024-11-21 09:30:14');
...
(66, 38, 1, 1, 250000.00, NULL),
(65, 38, 1, 1, 250000.00, NULL),
(64, 38, 6, 3, 500000.00, 5),
(63, 38, 5, 1, 180000.00, 4),
(67, 38, 6, 1, 500000.00, NULL),
(69, 38, 2, 1, 200000.00, NULL),
(68, 38, 2, 2, 200000.00, NULL);
...
(6, 'user03', '$2y$10$BwioDbCeq1yoboab.Q62c.waZJ49nI88WvTsK7XOU/Gz4KrUa4u0y', 'user', '2024-11-20 09:15:53'),
(7, 'user02', '$2y$10$Y5unrR2.HgVAmd2rQps1Dugb0YExwfuODZUxT3PGB1wj7emYajX0y', 'user', '2024-11-20 09:17:27');
